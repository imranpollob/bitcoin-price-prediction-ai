# -*- coding: utf-8 -*-
"""model_5_lstm_window7_horizon1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/imranpollob/bitcoin-price-prediction-ai/blob/main/notebooks/model_5_lstm_window7_horizon1.ipynb

# Model 5: LSTM Model (Window=7, Horizon=1)
This notebook demonstrates an LSTM neural network for Bitcoin price prediction using a window of 7 days to predict the next day.
"""
...
model_5.fit(train_windows, train_labels, epochs=100, verbose=0, batch_size=128, validation_data=(test_windows, test_labels))
...
plot_time_series(timesteps=bitcoin_prices.index[-len(test_windows):], values=model_5_preds, start=offset, format='-', label='model_5_preds')